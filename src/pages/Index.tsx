...
const DOG_AVATAR = 'https://cdn.poehali.dev/projects/992f73ca-449c-4310-a18d-9b2cb00c5fc9/bucket/de7a2082-20ac-4553-b9ae-710a5a9ee600.jpg';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background bg-grid relative overflow-hidden">
      ...
      {splashState !== 'gone' && (
        <div
          className={`fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden ${splashState === 'leaving' ? 'splash-down' : ''}`}
          style={{
            background: 'radial-gradient(circle at 50% 30%, #2a1247 0%, #0d0817 70%)',
          }}
        >
          {/* Decorative animated blobs */}
          <div className="pointer-events-none absolute -top-32 -left-32 w-[400px] h-[400px] rounded-full opacity-40 blur-3xl"
               style={{ background: 'radial-gradient(circle, #ff2d78, transparent 70%)' }} />
          <div className="pointer-events-none absolute -bottom-32 -right-32 w-[400px] h-[400px] rounded-full opacity-40 blur-3xl"
          ...
          <button
            ...
            className="rainbow-glow rainbow-bg relative px-10 py-5 md:px-14 md:py-6 rounded-full text-white font-black text-xl md:text-2xl uppercase tracking-wider border-4 border-white/80 active:scale-95 transition-transform"
